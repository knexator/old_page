import { generateAllPaths, playFromState } from "./helper";
...
function walkthroughToCoolestStateOfMagicTable(initialState) {
    let paths = generateAllPaths(initialState, nextStates, hanoiId);
    let any_valid = false;
...
play_button.addEventListener("click", (ev) => {
    playFromState(mainState, nextStates, hanoiId);
});
