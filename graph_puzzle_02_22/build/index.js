    ...
    function update(curTime) {
        ...
        if (!EDITOR) {
            ...
            if (mi > 0 && mi + 1 < MAX_T && mj >= 0 && mj < N_MODULES * 3) {
                ...
                let m_part = mj % 3;
                if ((0, engine_1.wasButtonPressed)("left") || (0, engine_1.wasButtonPressed)("right")) {
                    data[m_mod][m_part][mi] = cycleInput(data[m_mod][m_part][mi], (0, engine_1.wasButtonPressed)("left"));
                    writeContradictions();
                }
