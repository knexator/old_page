(function (factory) {
    ...
    exports.Layout = exports.Orientation = exports.DoubledCoord = exports.OffsetCoord = exports.Hex = exports.Point = void 0;
    class Point {
        constructor(x, y) {
            this.x = x;
            this.y = y;
    ...
    class Hex {
        ...
        static unfreeze(val) {
            let [q, r] = val.split(',').map(x => Number(x));
        ...
        mainDir() {
            ...
            let best_score = 0;
            for (let k = 0; k < 6; k++) {
                let cur_dir = Hex.directions[k];
                let cur_score = cur_dir.q * this.q + cur_dir.r * this.r + cur_dir.s * this.s;
    ...
    class Layout {
        ...
        pixelToHex(p) {
            ...
            var size = this.size;
            var origin = this.origin;
            var pt = new Point((p.x - origin.x) / size, (p.y - origin.y) / size);
