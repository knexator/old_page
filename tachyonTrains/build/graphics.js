        ...
        for (let k = 0; k < 6; k++) {
            ...
            if (cur_cable !== null && cur_cable.origin === k) {
                ...
                if (inputVal !== null && inputVal !== undefined) {
                    exports.ctx.strokeStyle = inputVal ? "white" : "black";
                }
                else {
                    exports.ctx.strokeStyle = "gray";
                }
                ...
                exports.ctx.fillStyle = fillStyles[cur_cable.direction];
                ...
                if (cur_cable.globalState[Math.floor(time)]) {
                    if (cur_cable.direction === "forward") {
                        let ballStart = cableSample(cur_cable, (0, index_1.mod)(time, 1), time);
                        ...
                        let ballStart = cableSample(cur_cable, 1 - (0, index_1.mod)(time, 1), time);
                        exports.ctx.beginPath();
                        exports.ctx.moveTo(ballStart.x, ballStart.y);
                        exports.ctx.arc(ballStart.x, ballStart.y, hexGame_1.layout.size * 0.2, 0, Math.PI * 2);
