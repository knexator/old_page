...
function getMat(mat: Matrix4, row: number, col: number): number {
...
export function pureRot(dist: number, axis_from: number, axis_to: number, dst?: Matrix4): Matrix4 {
  dst = identity(dst)
 ...
 */
export function copyMat(m: Matrix4, dst?: Matrix4): Matrix4 {
 ...
 */
export function identity(dst?: Matrix4): Matrix4 {
  dst = dst || new Float32Array(16);
 ...
 */
 export function transpose(m: Matrix4, dst?: Matrix4): Matrix4 {
  dst = dst || new Float32Array(16);
  if (dst === m) {
    let t;
 ...
 */
export function inverse(m: Matrix4, dst?: Matrix4): Matrix4 {
  dst = dst || new Float32Array(16);
 ...
 */
export function multMatMat(a: Matrix4, b: Matrix4, dst?: Matrix4): Matrix4 {
  dst = dst || new Float32Array(16);
 ...
 */
export function multMatVec(a: Matrix4, b: Matrix4, dst?: Vec4): Vec4 {
