import { pintar, CONFIG } from 'base'
...
function _mouseEvent(e: MouseEvent) {
  ...
  mouse.x = (x / pintar.canvas.clientWidth - .5) * (2 + CONFIG.EXTRA_MARGIN * 2);
  mouse.y = -(y / pintar.canvas.clientHeight - .5) * (1 + CONFIG.EXTRA_MARGIN * 2);
